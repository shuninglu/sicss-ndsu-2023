...
#' ZPM note: note the INVERSE RELATIONSHIP between sensitivity and specificity
library(pROC)
...
### ZPM Note: So ... how is this different from plain linear regression?
